    ...
    <>
      ...
      <header className="header">
        ...
        <div className="header__text-box">
          <h1 className="headeing-primary">
            <span className="headeing-primary--main">Outdoors</span>
            <span className="headeing-primary--sub">is where life happnes</span>
          </h1>
        ...
        <div className="row">
          ...
          <div className="col col-1-of-2">
            <p className="footer__copyright">
              Develope by{' '}
              <a
                href="https://muhammad-ufo.vercel.app/"
